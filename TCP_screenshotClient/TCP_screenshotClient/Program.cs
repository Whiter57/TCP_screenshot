...
class Program
{
    private const string ServerIp = "192.168.50.228";   /// Enter here the IP of the server (computer) that should receive screenshots
    private const int ServerPort = 12345;               /// You can change the port to any available port
    private const int CaptureIntervalInSeconds = 5;     /// Set the interval for sending a screenshot
